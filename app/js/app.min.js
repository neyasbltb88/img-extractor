...
function () {
  function SVGCollector() {
    ...
    _classCallCheck(this, SVGCollector);
  ...
  _createClass(SVGCollector, [{
    key: "_collectItems",
    value: function _collectItems() {
      var _this = this;

      this.svg_elems.forEach(function (elem) {
        var name;
        ...
        if (elem.id) {
          ...
          name = _this.name_index++;
        }

        _this.svg_items[_this.name_prefix + name + _this.name_suffix + '.' + _this.name_ext] = elem.outerHTML;
      });
    }
  }, {
    key: "downloadAll",
    value: function downloadAll() {
      for (var item in this.svg_items) {
        (0, _downloadjs.default)(this.svg_items[item], item, this.mime_type[this.name_ext]);
      }
    }
  }, {
    key: "init",
...
},{"downloadjs":2}],2:[function(require,module,exports){
